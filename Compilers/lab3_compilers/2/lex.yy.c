...
static yyconst flex_int16_t yy_base[14] =
    {   0,
        0,    0,    9,   10,    2,    0,    4,    0,    0,   10,
        0,   10,    5
    } ;

static yyconst flex_int16_t yy_def[14] =
    {   0,
       12,    1,   12,   12,   12,   13,    5,   13,    7,   12,
        7,    0,   12
    } ;
...
YY_RULE_SETUP
#line 7 "lab3_2.l"
{printf("ο δεκαπλάσιος ακέραιος:%d",atoi(yytext)*10);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 8 "lab3_2.l"
{printf("ο δεκαπλάσιος πραγματικός:%5.2f",atof(yytext)*10);}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 9 "lab3_2.l"
